...
FILE_TO_PROCESS = "/Users/user/Desktop/IndicDetect/Benchmark_Data/Task_Data/Adverisal_Attacks/Telugu/Paraphase_Attacks/Test.json"
...
def pipeline(sentence):
    try:
        ...
        te = " ".join(translate_once(ch, PIVOT_LANG, SRC_LANG) for ch in chunk_text(zh))
        return te
    except Exception:
        return sentence
...
if __name__ == "__main__":
    print("🚀 Telugu ↔ Chinese Back-Translation (deep-translator)\n")
    print("=" * 70)
