...
print("RUNNING Creative Writing SCRIPT v16 — QWEN API TAMIL PARALLEL (KEYWORDS + DIVERSITY)")

INPUT_JSON_PATH = "/Users/user/Desktop/IndicDetect/Benchmark_Data/Human_Written/Tamil/Creative_Writing/tamil_refined.jsonl"
OUTPUT_JSON_PATH = INPUT_JSON_PATH.rsplit(".", 1)[0] + "_creative_articles_Qwen_Plus.json"
...
def build_keyword_prompt(sample_text):
    ...
    return (
        f"கீழே உள்ள உரைப் பகுதிலிருந்து துல்லியமாக 4 இலக்கிய அல்லது கதையமைப்புச் சார்ந்த முக்கியச் சொற்களை "
...
def build_article_prompt(keywords):
    ...
    return (
        ...
        f"ஒரு புதிய, விரிவான நாவல் பாணி கதைநடைக் பகுதியை மட்டும் எழுதவும். "
        f"குறைந்தது 30 வாக்கியங்கள் இருக்க வேண்டும். "
        f"பாத்திரங்களின் உணர்ச்சிகள், வர்ணனையான காட்சிகள், இயல்பான உரையாடல்கள், "
        f"மற்றும் கதையின் நகர்வு தெளிவாக இருக்க வேண்டும். "
        f"அதே சொற்களை மீண்டும் மீண்டும் பயன்படுத்த வேண்டாம். பல்வகை வாக்கிய அமைப்பைப் பயன்படுத்தவும். "
        f"மேற்கோள்கள், விளக்கங்கள், அல்லது முன்னுரை வழங்க வேண்டாம். நாவல் பாணி கதைநடைக் பகுதியை மட்டும் எழுதவும்.\n\n"
        f"முக்கியச் சொற்கள்:\n{keywords}\n\nபுதிய நாவல் பாணி கதைநடைக் பகுதி:"
    )
...
def build_extend_prompt(keywords, existing_text):
    ...
    return (
        f"இந்த முக்கியச் சொற்களை அடிப்படையாகக் கொண்டு கீழே உள்ள தமிழ் நாவல் பாணி கதைநடைக் பகுதியை தொடரவும். "
        f"ஏற்கனவே எழுதப்பட்ட காட்சிகளை மீண்டும் எழுத வேண்டாம். "
        f"புதிய காட்சிகள், பாத்திரங்களின் மனநிலை, புதிய நிகழ்வுகள் மற்றும் "
        f"கதையில் திருப்பங்கள் மட்டும் சேர்க்கவும். "
        f"நாவல் பாணி தொடர வேண்டும். "
...
def process_single_sample(client, tokenizer, idx, sample_text):
    ...
    generic_prompt = (
    "முழுவதும் தமிழ் மொழியில் ஒரு புதிய, விரிவான நாவல் பாணி கதைநடைக் பகுதியை மட்டும் எழுதவும். "
    "குறைந்தது 30 வாக்கியங்கள் இருக்க வேண்டும். நாவல் பாணி கதைநடைக் பகுதியை மட்டும் எழுதவும்."
)
    for _ in range(3):
