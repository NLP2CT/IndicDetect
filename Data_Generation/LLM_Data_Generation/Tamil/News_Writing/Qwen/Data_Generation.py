...
print("RUNNING News Writing SCRIPT v16 — QWEN API TAMIL PARALLEL (KEYWORDS + DIVERSITY)")

INPUT_JSON_PATH = "/Users/user/Desktop/IndicDetect/Benchmark_Data/Human_Written/Tamil/News_Writing/tamil_1000_400-500_20260312_182718.jsonl"
OUTPUT_JSON_PATH = INPUT_JSON_PATH.rsplit(".", 1)[0] + "_news_articles_Qwen_Plus.json"
...
def build_keyword_prompt(sample_text):
    ...
    return (
        f"கீழே உள்ள செய்திக் கட்டுரையிலிருந்து துல்லியமாக 4 சுருக்கமான செய்தி முக்கியச் சொற்களை "
...
def build_article_prompt(keywords):
    ...
    return (
        ...
        f"ஒரு புதிய, விரிவான செய்திக் கட்டுரையை மட்டும் எழுதவும். கட்டுரை குறைந்தது 30 வாக்கியங்கள் இருக்க வேண்டும். "
        f"அதே சொற்களை மீண்டும் மீண்டும் பயன்படுத்த வேண்டாம். பல்வகை வாக்கிய அமைப்பைப் பயன்படுத்தவும். "
        f"மேற்கோள்கள், விளக்கங்கள், அல்லது முன்னுரை வழங்க வேண்டாம். செய்திக் கட்டுரையை மட்டும் எழுதவும்.\n\n"
        f"முக்கியச் சொற்கள்:\n{keywords}\n\nபுதிய செய்திக் கட்டுரை:"
    )
...
def build_extend_prompt(keywords, existing_text):
    ...
    return (
        f"இந்த முக்கியச் சொற்களை அடிப்படையாகக் கொண்டு கீழே உள்ள தமிழ் செய்திக் கட்டுரையை தொடரவும். "
        f"ஏற்கனவே எழுதப்பட்ட விஷயங்களை மீண்டும் எழுத வேண்டாம். "
        f"புதிய விவரங்கள், புதிய கோணங்கள், புதிய தகவல்கள் மட்டும் சேர்க்கவும். "
...
def process_single_sample(client, tokenizer, idx, sample_text):
    ...
    generic_prompt = (
    "முழுவதும் தமிழ் மொழியில் ஒரு பொதுவான செய்திக் கட்டுரையை எழுதவும். "
    "குறைந்தது 30 வாக்கியங்கள் இருக்க வேண்டும். செய்திக் கட்டுரையை மட்டும் எழுதவும்."
)
    for _ in range(3):
