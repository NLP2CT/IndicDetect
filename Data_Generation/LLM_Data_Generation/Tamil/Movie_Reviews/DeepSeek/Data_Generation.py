...
print("RUNNING Movie Reviews SCRIPT v16 — DEEPSEEK API TAMIL PARALLEL (KEYWORDS + DIVERSITY)")
...
OUTPUT_JSON_PATH = INPUT_JSON_PATH.rsplit(".", 1)[0] + "_movie_reviews_articles_DeepSeek_v3.json"
