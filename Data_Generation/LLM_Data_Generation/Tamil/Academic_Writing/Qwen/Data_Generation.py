...
print("RUNNING Academic Writing SCRIPT v16 — QWEN API TAMIL PARALLEL (KEYWORDS + DIVERSITY)")
...
OUTPUT_JSON_PATH = INPUT_JSON_PATH.rsplit(".", 1)[0] + "_academic_articles_Qwen_Plus.json"
