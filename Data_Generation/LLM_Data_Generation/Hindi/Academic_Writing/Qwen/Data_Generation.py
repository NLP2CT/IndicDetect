...
print("RUNNING Academic Writing SCRIPT v16 — QWEN API HINDI PARALLEL")

INPUT_JSON_PATH = "/Users/user/Desktop/IndicDetect/Benchmark_Data/Human_Written/Hindi/Academic_Writing/hindi_academic_1000.jsonl"
OUTPUT_JSON_PATH = INPUT_JSON_PATH.rsplit(".", 1)[0] + "_academic_articles_Qwen.json"
...
def build_keyword_prompt(sample_text):
    ...
    return (
        f"निम्नलिखित पाठ से ठीक 4 शैक्षणिक या अकादमिक मुख्य शब्द "
...
def build_article_prompt(keywords):
    ...
    return (
        ...
        f"एक नया, विस्तृत अकादमिक लेख ही लिखें। "
        f"लेख में कम से कम 30 वाक्य होने चाहिए। "
        f"शोध शैली, तार्किक संरचना, स्पष्ट विश्लेषण होना चाहिए। "
        f"एक ही शब्दों को बार-बार उपयोग न करें। विविध वाक्य संरचना का उपयोग करें। "
        f"निर्देश, विवरण, या भूमिका न दें। केवल अकादमिक लेख ही लिखें।\n\n"
        f"मुख्य शब्द:\n{keywords}\n\nनया अकादमिक लेख:"
    )
...
def build_extend_prompt(keywords, existing_text):
    ...
    return (
        f"इन मुख्य शब्दों के आधार पर निम्नलिखित हिंदी अकादमिक लेख को आगे बढ़ाएँ। "
        f"पहले से लिखे गए अंशों को दोबारा न लिखें। "
        f"केवल नया विश्लेषण, नए शोध दृष्टिकोण, नई जानकारी जोड़ें। "
        f"तार्किक शैली बनी रहनी चाहिए। "
...
def process_single_sample(client, tokenizer, idx, sample_text):
    ...
    generic_prompt = (
    "पूर्णतः हिंदी भाषा में एक नया, विस्तृत अकादमिक लेख ही लिखें। "
    "कम से कम 30 वाक्य होने चाहिए। केवल अकादमिक लेख ही लिखें।"
)
    for _ in range(3):
