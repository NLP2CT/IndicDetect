...
class Binoculars(object):
    def __init__(
        ...
        uses_falcon = (
            FALCON_OBSERVER in observer_name_or_path
            and FALCON_PERFORMER in performer_name_or_path
        )
        if not uses_falcon:
            logging.warning(
                f"Hardcoded thresholds were calibrated on {FALCON_OBSERVER} / {FALCON_PERFORMER}. "
