...
def get_metrics(real_preds, sample_preds, threshold):
    ...
    # --- Macro Metrics ---
    # The Macro-F1 is the unweighted average of F1 scores for both classes
    macro_f1 = (f1_0 + f1_1) / 2
    
    # We use Class 1 (Positive) precision/recall for standard reporting
    precision = prec_1 
    recall = rec_1
